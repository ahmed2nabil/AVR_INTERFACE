...
ISR(INT1_vect)
{
	g_Interrupt_Flag = 1; //put this flag so i dont block the code for a long time so we put flag for each interrupt and then check the flag if intrrrupt happens go set flag =1 and go to code
}
